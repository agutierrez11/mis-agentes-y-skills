...
def execute_skill(project, input_path):
    print("=" * 60)
    print(f"🛠️ EXECUTION ENGINE: AGENT-PLATFORM-MIGRATE-FROM-AI-STUDIO")
    print("=" * 60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Agent Platform Migrate From Ai Studio Engine")
