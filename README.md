...
Este repositorio cuenta con **853 Skills Agénticas Especializadas** en desarrollo web, inteligencia comercial, ciencia de datos, DevOps, diseño UI/UX y aceleración con modelos de IA.

📘 **[`CATALOGO_SKILLS.md`](./CATALOGO_SKILLS.md)** — Consulta el catálogo completo indexado con descripciones y enlaces directos.

### Ejemplo de Skills Destacadas:
- 🎨 `awesome-claude-design`: Sistemas de diseño UI/UX premium (Linear, Stripe, Vercel).
- 🕵️ `agent-reach`: Scraping e inteligencia en tiempo real en +13 redes sociales.
- 🧠 `warden-agent-orchestrator`: Orquestación de agentes locales con deliberación multi-modelo.
...
*Ver el catálogo completo con las 853 skills en [CATALOGO_SKILLS.md](./CATALOGO_SKILLS.md).*
